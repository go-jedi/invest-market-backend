...
type TodoUser interface {
	...
	CheckIsCaptcha(valueUser int64) (bool, int, error)
	...
	UpdateTradingAsset(tradingAssetForm appl_row.UserUpdateTradingAsset) (int, error)
	UpdateTradingInvestPrice(tradingAssetForm appl_row.UserUpdateTradingInvestPrice) (int, error)
	UpdateTradingWaitTime(tradingAssetForm appl_row.UserUpdateTradingWaitTime) (int, error)
	UpdateTradingMovePrice(tradingAssetForm appl_row.UserUpdateTradingMovePrice) (int, error)
	GetUserTradingParams(teleId int64) ([]appl_row.UserGetUserTradingParams, int, error)
	GetUserTotalEarn(teleId int64) ([]appl_row.UserGetTotalEarn, int, error)
	ChangeUserTotalEarn(teleId int64, earnMoney float64) (int, error)
	GetUserCurrentLuck(teleId int64) ([]appl_row.UserGetCurrentLuck, int, error)
}
...
type TodoAdmin interface {
	...
	AdminChangeLuckUser(teleId int64, needLuck string) (int, error)
}
