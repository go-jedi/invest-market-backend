CREATE OR REPLACE FUNCTION admin_withdraw_approve(_tid BIGINT, _uid character varying)
	RETURNS BOOLEAN
	LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
	...
	UPDATE users_base SET conclusion = conclusion - _uwe.price WHERE _tid = _tid;
